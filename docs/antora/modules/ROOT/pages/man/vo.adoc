...
Syntax: vo <cmd-options> [<variable-name> [<variable-name> [...]]]

Command Options Usage:
  vo [-AFLORTacglrst] [-y <name>] [-z <name>] [-f <format>] [-G <gdb-format>] [-d <none>] [-S <boolean>] [-D <count>] [-P <count>] [-Y[<count>]] [-V <boolean>] [-Z <count>] [<variable-name> [<variable-name> [...]]]
...
'vo' is an abbreviation for 'frame variable -O'
----