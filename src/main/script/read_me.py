...
def __lldb_init_module(debugger: lldb.SBDebugger = lldb.debugger, internal_dict: dict = None):
    """
    加载脚本后由 lldb 执行。
...
def command_formatter(debugger: lldb.SBDebugger = lldb.debugger,
                      command: str = None,
                      exe_ctx: lldb.SBExecutionContext = lldb.SBExecutionContext(),
